<!-- This is Visit Our Campus Section -->
<section class="visit-our-campus" id="visit-our-campus">
    <div class="container">
        <div class="campus-image">
            <img src="<?php echo get_template_directory_uri(); ?>/images/Campus.png" alt="Campus">
        </div>

...
<section id="jcu-rankings-logos" class="ads-logos-section">
    <div class="rankings-logos-container">
        ...
        <div class="ranking-logo animated-logo" data-delay="1900">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad1.png" alt="#1AUS and #1WORLD for Sustainable Edu">
        </div>
        <div class="ranking-logo animated-logo" data-delay="2635">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad2.png" alt="Top 2% university in the world">
        </div>
        <div class="ranking-logo animated-logo" data-delay="2300">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad3.png" alt="#5 in the World THE impact Rankings">
        </div>
        <div class="ranking-logo animated-logo" data-delay="1350">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad4.png" alt="#1 in the World for Marine and Freshwater Bio">
        </div>
        <div class="ranking-logo animated-logo" data-delay="800">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad5.png" alt="5 Stars Good Universities Guide">
        </div>
        <div class="ranking-logo animated-logo" data-delay="1550">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad6.png" alt="IRUA membership">
        </div>
        <div class="ranking-logo animated-logo" data-delay="1100">
            <img src="<?php echo get_template_directory_uri(); ?>/images/ad7.png" alt="5 Stars QS URanking">
        </div>
    </div>
</section>